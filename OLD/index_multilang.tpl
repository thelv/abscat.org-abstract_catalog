	...
	<head>
		...
		<style>
			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			#likes{margin-bottom:6px;overflow:hidden;padding-top:15px}
			...
			#comments_cont{padding-left:18px;position:fixed;right:0px;background:white;top:0;padding-right:0;4px;padding-left:16px;height:100%}
				...
				#comments_cont_padding{height:31px;-margin-top:31px;width:367px;}
			...
			<script>				
				...
				{				
					...
					loadByUrl: function(url_)
					{
						...
						document.title=this.title(urlData ? urlData : {});
					}					
				};
