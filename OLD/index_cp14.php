	...
	<head>
		...
		<script type="text/javascript" src="http://vk.com/js/api/share.js?10" charset="windows-1251"></script>
			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			.like{float:left;min-height:20px;}
				#facebook_like{width:64px;110px;padding-left:0px}
			...
			.commentsComment + div{border-bottom:1px solid /*#dddde7;*/#d9d9e0;/*#d6d6d6;*/#ccc;#d0d0e3;/*#dddde9;#ccccd0;*/#e3e3ee;#ddf;#d0d0e3;f0;#d9d9f3;/*#d3d3ee;*/#ddf;#ccc;#cccccc;#cecece;#d0d0d0;d6d6d6;margin-left:48px;margin-right:9px}
				...
				<!-- LIKES -->
					<div id=likes>
						...
						<div class="like" id="tweeter_like">
							<a href="https://twitter.com/share" class="twitter-share-button" data-via="" data-text--="Скачать музыку бесплатно и просто!">Tweet</a>
						...
						<div  class="like" id="vk_like">
							<script type="text/javascript">
							<!--
								document.write(VK.Share.button({image: "", noparse: true},{type: "round", text: "ВКонтакте"}));
							-->
							</script>
						</div>
					</div>
