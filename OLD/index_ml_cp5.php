...
<html>
	<head>
		...
		<style>
			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				#youtube_._hided{height:80px;}
					...
					#youtube_ ._head a:hover{color:#22f;text-decoration:underline}					
						...
						#youtube_ ._hint{display:none;position:absolute;padding:4px 7px 6px 7px;color:#aaa;left:0;background:#000 url('/img/pause2.png') 11px 10px no-repeat;background-size:30px;padding-left:52px;min-height:40px;width:310px;justify-content: center;flex-direction: column;}
						...
						#youtube_[state_play="stopped"] ._hint{background:#000 url('/img/play.png') 11px 10px no-repeat;background-size:30px;}
						#youtube_[state_play="loading"] ._hint{background:#000 url('/img/loading.png') 11px 10px no-repeat;background-size:30px;}
			...
			#likes{margin-bottom:6px;overflow:hidden;padding-top:16px}
			...
			#comments_cont{padding-left:18px;position:fixed;right:0px;background:white;top:0;padding-right:0;4px;padding-left:16px;height:100%}
				#comments_cont > table{height:100%}
				#comments_cont_padding{height:30px;-margin-top:31px;width:367px;}
				#comments_cont_{width:367px;position:relative}
				
				#comments{overflow-y:scroll;width:367px;height:100%;position:absolute;top:0}
			...
			2*/
				...
				.commentsComment{padding-bottom:3px;overflow:hidden;padding-top:8px;border-bottom:1px solid #ccc;stransparent;#ccc;ddd;#e5e5e5;#e5e5e5;#eaeaea;#e9e9e9;margin-right:10px}
				.commentsComment:hover{background:#f7f7f7;#fafafa;#f5f5f5;border:1px solid #ddd;#e3e3e3;e3e3e3;border-width:1px 0;margin-top:-1px;position:relative}
				...
				.commentsRight{overflow:hidden;padding-left:10px;8px}
					.commentsTextarea textarea{width:293px;height:56px;padding:3px 4px;/*border:1px solid #bbb;*/margin-bottom:7px;display:block;font-size:14px;font-family:tahoma}
	...
	border:1px solid #ddd
					*/
					...
					.commentsQuote{border-left:1px solid #ccc;#c9c9d0; padding-left:9px;margin:8px 0 4px 0;overflow:hidden}
	...
	<body>
		...
		<div id="body">
				...
				<!-- LIKES -->
					<div id=likes>
						...
						<div  class="like" id="vk_like">
							<script type="text/javascript">
							<!--
								document.write(VK.Share.button({image: "", noparse: true},{type: "round", text: "Сохранить"}));
							-->
							</script>
						</div>
					</div>
			...
			<div id=players>
				...
				<div id="vk" class="__hided _fix_on_comments_right">
					<div class=_head>
				...
				<div id="youtube_" class="_hided _fix_on_comments_right">
					<div class=_head>
			...
			<script>				
				...
				$(function()
				{
					...
					$('._fix_on_comments_right').css('margin-left', '-'+scrollBarWidth+'px');
				...
				var vk=
				{
					...
					open: function(q)
					{
						...
						//setTimeout(function(){
							vk.window=window.open('/vk_redir.php?url='+encodeURIComponent('https://m.vk.com/audio?q='+encodeURIComponent(q))+'#', 'vk'/*+(++window.name)*/, 'width='+width+',height='+height+',top='+top+',left='+left);
						//}, 0);
						//this.window.focus();
