			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				#youtube_._hided{height:80px;}
					#youtube_._hided ._video{height:50px;position:relative;overflow:hidden;background:#000}
			...
			2*/
				...
				#commentsAdd{margin-bottom:12px;}
				.commentsComment{padding-bottom:10px;12;overflow:hidden}
				.commentsRight{overflow:hidden;padding-left:10px;8px}
					.commentsTextarea textarea{width:295px;height:56px;padding:3px 4px;border:1px solid #bbb;margin-bottom:7px;display:block;font-size:14px;font-family:tahoma}
