			...
			*{padding:0;margin:0;}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				#trees{margin-top:10px}														
					.tree{margin-top:5px}
					.tree .object{color:#000;line-height:20px;cursor:pointer;display:inline-block}
			...
			#window_container{display-:none;position:fixed;left:0;top:0;background:rgba(0,0,0,0.5);width:100%;height:100%}
				...
				#window_object_connect_with_a_new_object{width:547px}
					...
					#window_object_connect_with_a_new_object input[type=text]{width:186px;text-indent:2px}
					#window_object_connect_with_a_new_object ._form:last-child{width:300px}
					#window_object_connect_with_a_new_object textarea{width:286px;text-indent:2px}
				#window_object_edit{width:327px}
					#window_object_edit ._form{width:200px}
					#window_object_edit input[type=text]{width:186px;text-indent:2px}
					#window_object_edit ._form:last-child{width:300px}
					#window_object_edit textarea{width:286px;text-indent:2px}
		...
		<div id="body">							
			...
			<div id="window_container">
				<div id=window_object_connect_with_a_new_object class=window>
					<div class=_head>
						Connect the object with a new object
					</div>
					<div class=_body>
						<div class=_form>
							<div class=_head>
		...
		<script>		
			...
			var Branch=function(objectId, connectionId, connectionStraightOrOpposite, parent)
			{
				...
				else
				{
					...
					');
					this.node.find('.connection').text(connectionText+':');					
				}
