<html><head>
	...
	<body>
		...
		<div id="body">	
			...
			<b style="display:block;margin-bottom:5px">My catalog - Eval script</b>
			<a class="__blue" style="
				margin-right: 4px;
				margin-bottom: 5px;
				display: inline-block;
			">← back</a> <a class="__blue" style="
				margin-right: 4px;
				margin-bottom: 5px;
				display: inline-block;
			">documentation</a>
			<a class="__blue">saved scripts</a>
...
<div style="
    ...
    margin-top: 11px;
    /* text-decoration: underline; */
">Script result:</div><div style="/* margin-top:14px; */color:gray;padding-bottom: 30px;">empty</div>
					<!-- </div>
				</div> -->
			</div>
		...
		<div id="body_hide" onclick="$(this).hide();" style="position: fixed; left: 0px; top: 0px; background: rgba(0, 0, 0, 0.498039); width: 100%; height: 100%; display: none;">
							...
							<tbody><tr>
								<td style="padding-right:20px">
									...
									<div style="margin-bottom:10px;vertical-align:top">
										<span style="vertical-align:top">1. Element text: <br><textarea style="display:inline-block;margin-top:5px;width:350px"></textarea></span>
									</div>
									<div style="margin-bottom:10px;vertical-align:10%">
										<span style="vertical-align:top">2. Element color: </span>
...
</div><div id="ulogin_receiver_container" style="margin: 0px; padding: 0px; outline: none; border: none; border-radius: 0px; cursor: default; float: none; position: relative; display: none; width: 0px; height: 0px; left: 0px; top: 0px; box-sizing: content-box;"><iframe name="easyXDM_default5697_provider" id="easyXDM_default5697_provider" frameborder="0" src="https://ulogin.ru/stats.html?r=49659&amp;type=small&amp;xdm_e=http%3A%2F%2Fcatalog.thelv.ru&amp;xdm_c=default5697&amp;xdm_p=1" style="margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; position: absolute; left: 0px; top: 0px; overflow: hidden; width: 100%; height: 100%;"></iframe></div><div class="ulogin-dropdown" id="ul_1487952996434" style="margin: 0px; padding: 0px; outline: none; border: 5px solid rgb(102, 102, 102); border-radius: 4px; cursor: default; float: none; position: absolute; display: none; width: 128px; height: 310px; left: 0px; top: 0px; box-sizing: content-box; z-index: 9999; box-shadow: rgba(0, 0, 0, 0.137255) 0px 2px 2px 0px, rgba(0, 0, 0, 0.2) 0px 3px 1px -2px, rgba(0, 0, 0, 0.117647) 0px 1px 5px 0px;"><iframe name="easyXDM_default5698_provider" id="easyXDM_default5698_provider" frameborder="0" src="https://ulogin.ru/version/2.0/html/drop.html?id=0&amp;redirect_uri=http%3A%2F%2Fcatalog.thelv.ru&amp;callback=&amp;providers=facebook,twitter,google,yandex,livejournal,openid,flickr,lastfm,linkedin,liveid,soundcloud,steam,uid,webmoney,youtube,foursquare,tumblr,vimeo,instagram,wargaming&amp;fields=first_name,last_name&amp;force_fields=&amp;optional=&amp;othprov=vkontakte,odnoklassniki,mailru,facebook&amp;protocol=http&amp;host=catalog.thelv.ru&amp;lang=ru&amp;verify=&amp;sort=relevant&amp;m=0&amp;icons_32=&amp;icons_16=&amp;theme=classic&amp;client=&amp;page=http%3A%2F%2Fcatalog.thelv.ru%2Findex_cp3.php&amp;version=1&amp;xdm_e=http%3A%2F%2Fcatalog.thelv.ru&amp;xdm_c=default5698&amp;xdm_p=1" style="margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; position: relative; left: 0px; top: 0px; overflow: hidden; width: 128px; height: 310px;"></iframe><div style="margin: 0px; padding: 0px; outline: none; border: 5px solid rgb(102, 102, 102); border-radius: 0px; cursor: default; float: none; position: absolute; display: inherit; width: 41px; height: 13px; left: initial; top: 100%; box-sizing: content-box; background: rgb(0, 0, 0); right: -5px; text-align: center;"><a href="" target="_blank" style="margin: 0px; padding: 0px; outline: none; border: none; border-radius: 0px; cursor: default; float: none; position: relative; display: inherit; width: 41px; height: 13px; left: 0px; top: 0px; box-sizing: content-box; background: url(&quot;https://ulogin.ru/img/text.png&quot;) no-repeat;"></a></div></div></body></html>