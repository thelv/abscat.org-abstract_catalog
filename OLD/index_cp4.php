...
">
									...
									<div style="margin-bottom:10px;padding-left:12px;background: url(/img/list3.png) no-repeat 0px 6px;margin-left:-2px; padding-left:16px;">
										...
										<input type="checkbox">Yes, group name: <input><span style="font-weight:normal;display:block;margin-top:5px;color:gray">An array of connections will be hided by default when showing the tree.</span>
									</div>
									<div style="padding-left:12px;background: url(/img/list3.png) no-repeat 0px 6px;margin-left:-2px;padding-left:16px;margin-bottom: 10px;">
										...
										<input type="checkbox">Yes<span style="display:block;margin-top:5px;color:gray">Note that all not array connections will be shown if the current element is in the root position of the tree.</span>
									</div>					
...
">
									...
									<div style="margin-bottom:10px;padding-left:12px;background: url(/img/list3.png) no-repeat 0px 6px;margin-left:-2px; padding-left:16px;">
										<b style="font-weight:normal;display:block;margin-bottom:7px">Is this connection is a part of array of one type connections?</b>
										<input type="checkbox">Yes, group name: <input>
									</div>
									<div style="padding-left:12px;background: url(/img/list3.png) no-repeat 0px 6px;margin-left:-2px;padding-left:16px;margin-bottom-: 10px;">
										<b style="font-weight:normal;display:block;margin-bottom:7px">Is this connection should be hidden by default?</b>							
