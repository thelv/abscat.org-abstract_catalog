	...
	<body>
		...
		<div id="body">
			...
			<div id="youtube_" class="_hided">
				<div class=_head>
					<div class=_head_title>video:</div>&nbsp;<select><option>Mage - The time Is Always Running Out</option></select><!--
					--><a class="_action_close">close</a><a class="_action_show">show</a><a class="_action_hide">hide</a><a class="_action_stop">stop</a>
				</div>
				<div class=_video>
			...
			<script>		
				...
				var table=function(data, catId, filterType, filterText)
				{
					...
					{				
						...
						for(var i in type.objects)
						{
							...
							var objectNode=$('<div class=table_type_object><div><a onclick="return false;"></a></div><div class=_menu_icon></div></div>');
				...
				{				
					...
					gen: function(urlData)
					{
						...
						{
							res=url.langPrefix.'/cat'+urlData.catId;
						}
