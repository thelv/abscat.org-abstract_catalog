			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			#head > div{font-size:15px;overflow:hidden;margin:0px 0px;border-bottom:1px solid #ddd;padding:6px 10px 6px 10px;background:#eee;height:18px}
				...
				#profile{float:right}
					...
					#save{float:right;padding:5px 10px;/*position:fixed;bottom:0;right:0;*/background:rgba(220, 220, 220, 0.94);position:relative}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				.body_body{margin-top:6px;padding-right:397px}
					...
					#page_catalog{}						
						.object_filter{margin-top:11px}
							.object_filter input[type=text]{border:1px solid #ccc;padding:1px 0;width:100px;text-indent:2px}
							.object_filter input[type=text]{border:1px solid #ccc;padding:1px 0;width:100px;text-indent:2px}
						...
						.table{vertical-align:top;margin-top:15px;11px}
							...
							.table td:first-child + td{border-left:1px solid #d9d9e0}
							.table td:first-child + td > div{padding-left:15px}
							.table td:first-child .table_type_head{border-bottom:1px solid  #d9d9e0;padding-right:15px;color:#888;padding-right:0}
							...
							.table_type_head{font-weight-:bold;font-style-:italic;margin-bottom:/*7px*/5px;padding-bottom:8px;border-bottom:1px solid  #d9d9e0;padding-right:29px;color:#000;position:relative}
				...
				#buffer{padding:5px 10px 5px 10px;position:fixed;bottom:0;left:0;background:rgba(220, 220, 220, 0.94);z-index:2}
				...
				#players{position:fixed;right:0;bottom:0;}
				...
				#player_bar{white-space:nowrap;float:right;clear:both;display:none;/*position:fixed;right:0;bottom:0;*/padding:5px 10px;background:url(https://maxcdn.icons8.com/Share/icon/Music//musical_notes1600.png) 6px 5px no-repeat, rgba(220, 220, 220, 0.94)  /*url('https://maxcdn.icons8.com/Share/icon/Very_Basic//lock1600.png') 15px 5px no-repeat*/;background-size:19px;padding-left:29px}
				#player_bar._locked{background:url(https://maxcdn.icons8.com/Share/icon/Music//musical_notes1600.png) 6px 5px no-repeat, rgba(220, 220, 220, 0.94)  url('https://maxcdn.icons8.com/Share/icon/Very_Basic//lock1600.png') 26px 6px no-repeat;background-size:19px, 16px;padding-left:45px}
					...
					#player_head ._action_lock{background:url('https://maxcdn.icons8.com/Share/icon/Very_Basic//lock1600.png') 0px 1px no-repeat;background-size:16px;width:20px;height:20px;margin-right:-7px}
					
				#player{display: none;position:fixed;right:0;bottom:0;width:361px;}
				
					#player_head{overflow:hidden;padding:5px 7px 4px 7px;height:20px;height:auto;border:1px solid #ccc;border-width:1px 0 0 1px;position:relative;border-bottom:1px solid #ddd;background:#eee url(https://maxcdn.icons8.com/Share/icon/Music//musical_notes1600.png) 4px 4px no-repeat;background-size:21px;margin-bottom:-1px;}
					...
					#vk{height:27px;background:rgba(220, 220, 220, 0.94);border:0;/*border-bottom:1px solid #c0c0c0*/}
						#players._youtube_showed #vk{height:auto;border:1px solid #ccc;#d6d6d6;border-width:1px 0 0 1px;position:relative;border-bottom:1px solid #ddd;background:#eee;margin-bottom:-1px;border-top:1px solid #ccc}
					...
					#youtube_._closed select{background:#ccc}*/
						...
						#youtube_ ._head a:hover{color:#22f;text-decoration:underline}					
							...
							#youtube_ ._hint{display:none;position:absolute;padding:4px 7px 6px 7px;color:#aaa;left:0;background:#000 url('/img/pause2-1.png') 7px 10px no-repeat;background-size:30px;padding-left:44px;min-height:40px;width:310px;justify-content: center;flex-direction: column;}
							...
							#youtube_[state_play="stopped"] ._hint{background:#000 url('/img/play-1.png') 7px 10px no-repeat;background-size:30px;}
							#youtube_[state_play="loading"] ._hint{background:#000 url('/img/loading-1.png') 7px 10px no-repeat;background-size:30px;}
			...
			.like{float:left;min-height:20px;cursor:pointer}
				#facebook_like{-width:64px;110px;padding-left:0px;background:url(/img/facebook-like.png) no-repeat; width:56px}
				#tweeter_like, #tweeter_like iframe{width:63px !important;overflow:hidden}
				#google_plus_like, #google_plus_like > div, #google_plus_like iframe{width:/*65px*/34px !important;oveflow:hidden}
				#google_plus_like{background:url(/img/google-plus-like.png) no-repeat; width:34px}
				#vk_like, #vk_like_button{overflow:hidden;}
				#vk_like{margin-right:2px;background:url(/img/vk-like.png) no-repeat; width:92px;height:21px}
			...
			.commentsComment + div{border-bottom:1px solid /*#dddde7;*/#d9d9e0;/*#d6d6d6;*/#ccc;#d0d0e3;/*#dddde9;#ccccd0;*/#e3e3ee;#ddf;#d0d0e3;f0;#d9d9f3;/*#d3d3ee;*/#ddf;#ccc;#cccccc;#cecece;#d0d0d0;d6d6d6;margin-left:48px;margin-right:8px;}
			...
			2*/
				...
				.commentsRight{overflow:hidden;padding-left:10px;8px}
					.commentsTextarea textarea{width:290px;height:56px;padding:3px 4px;border:1px solid #ccc;#bbb;margin-bottom:7px;display:block;font-size:14px;font-family:tahoma}
			...
			<div id=comments_cont><table cellpadding=0 cellspacing=0><tr><td id=comments_cont_padding></td></tr><tr><td id=comments_cont_><div id=comments>
				...
				<!-- LIKES -->
					<div id=likes>
						...
						<div  class="like" id="vk_like">
							<!-- <script type="text/javascript">								
								function scriptVkShareOnLoad()
								{
									$('#vk_like').append(VK.Share.button({image: "", noparse: true},{type: "round", text: "ВКонтакте"}));
								}
							</script>-->
						</div>
					</div>
				...
				<!-- COMMENTS -->				
					...
					<div id=commentsHeader style="line-height:20px;clear:left;displ-ay:none;padding: 0px 0px 5px 0;margin-bottom: 3px;margin-right:8px;margin-top: 0px;overflow: hidden;font-weight: bold;color: #222;"> 
						<!-- <img src="/img/menu2.png?" style="float:right;margin-right:-5px;/*position:relative;top:1px*/"> -->
						<!-- <img width=18 src="/img/comment_icon2.png" style="float:right;margin-right:-2px;position:relative;top:1px">--> <a style="float:right;color:#22f;font-weight: normal;-padding-right: 5px;">$@{hide}</a>
						$@{Comments}
						<!-- <div style="color: #696969;display: inline;font-weight: normal">
						(<u id="commentsHide" onclick="$('#comments').addClass('commentsHidden');$.cookie('comments_hided', '1', {expires: 300});window[yaCounter].reachGoal('comments_hide')">$@{hide}</u>
						</div> -->
					</div>
			...
			<script>
						...
						{				
							...
							var typeObjectsNodeCreate=function(objects)
							{
								...
								for(var i in objects)
								{
									...
									objectNode.find('._play').click((function(object){return function(){player.open(object.text);/*vk.open(object.text);*/};})(object));
				...
				{			
					...
					post: function()
					{
						...
						$.ajax(
						{
							url: 'https://abscat.org/comments_server/',
							dataType: 'text',
							data: 
							{
								type: 'post',
...
.commentsTextSong {
    ...
    display: inline-block;
    /* color: rgb(238, 68, 68); */
    background: url(https://maxcdn.icons8.com/Share/icon/Music//musical_notes1600.png) 2px 2px no-repeat, #f5f5f5;
    cursor: pointer;
    ...
    display: inline-block;
    /* color: rgb(238, 68, 68); */
    background: url(https://maxcdn.icons8.com/Share/icon/Music//musical_notes1600.png) 2px 50% no-repeat, #f5f5f5;
    cursor: pointer;
    ...
    color: #aaa;
    left: 0;
    background: #000 url(/img/pause2-1.png) -2px 2px no-repeat;
