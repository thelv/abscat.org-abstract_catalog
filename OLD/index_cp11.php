<html>
		...
		<style>
			*{padding:0;margin:0;}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				.catalog_createobject_link{display:inline-block;padding-top:7px}
				.catalog_go_back{display:inline-block;padding-top:7px;margin-right:10px}
	...
	<body>
		...
		<div id="body">
			...
			</div><!-- <div class="catalog_createobject_link __blue">
				create a new object
			</div>-->
			<br>
			<div id=trees>
