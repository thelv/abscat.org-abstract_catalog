			...
			*{padding:0;margin:0;text-decoration:none;}
			...
			#head > div{font-size:15px;overflow:hidden;margin:0px 0px;border-bottom:1px solid #ddd;padding:6px 10px 6px 10px;background:#eee;height:18px}
				...
				#profile{float:right}
					...
					#save{padding:5px 10px;position:fixed;bottom:0;right:0;background:rgba(220, 220, 220, 0.94);}
			...
			#body{font-size:14px;overflow:hidden;margin:6px 10px;margin-top:37px;}							
				...
				#players{position:fixed;right:0;bottom:0;width:361px}
					#players._youtube_showed #vk{height:auto;border:1px solid #ccc;border-width:1px 0 0 1px;position:relative;border-bottom:1px solid #ddd;background:#eee;margin-bottom:-1px;}
					#players._vk_showed #save{margin-bottom:27px}
					#players._youtube_showed #save{margin-bottom:0px}
				
				#vk{/*position:fixed;right:0;bottom:0;*/width:360px;z-index:;display:none;}
			...
			.commentsComment + div{border-bottom:1px solid #d0d0e3;/*#dddde9;#ccccd0;*/#e3e3ee;#ddf;#d0d0e3;f0;#d9d9f3;/*#d3d3ee;*/#ddf;#ccc;#cccccc;#cecece;#d0d0d0;d6d6d6;margin-left:48px;margin-right:9px}
			...
			2*/
				...
				.commentsRight{overflow:hidden;padding-left:10px;8px}
					.commentsTextarea textarea{width:290px;height:56px;padding:3px 4px;-border:1px solid #bbb;#bbb;margin-bottom:7px;display:block;font-size:14px;font-family:tahoma}
			...
			<script>				
				...
				var vk=
				{
					...
					open: function(q)
					{
						...
						//setTimeout(function(){
							vk.window=window.open('/vk_redir.php?width='+width+'&height='+height+'&left='+left+'&top='+top+'&url='+encodeURIComponent('https://m.vk.com/audio?q='+encodeURIComponent(q)), 'vk'/*+(++window.name)*/, 'width='+width+',height='+height+',top='+top+',left='+left);
						//}, 0);
						//this.window.focus();
