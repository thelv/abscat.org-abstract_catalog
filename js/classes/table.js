			...
			var typeObjectsNodeCreate=function(objects)
			{
				...
				for(var i in objects)
				{
					...
					objectNode.find('.object_play')
						.click((function(object){return function(){player.open(object.text);/*vk.open(object.text);*/};})(object))
						.contextmenu((function(object){return function(e){vk.stop();vk.open(object.text);e.preventDefault();return false;/*vk.open(object.text);*/};})(object))
					;
								...
								, 
									[	
										/*{
											...
											action: function()
											{
												Object_.actions.open(object, catId);													
											}
										},
										{
											...
											action: function()
											{
												Object_.actions.openInNewTab(object, catId);													
											}
										},*/
										{
